...
生成时间: 2026-02-24 12:59:24

## 1. 内存使用概览

| 内存类型 | 已使用 | 最大值 | 使用率 |
|---------|--------|--------|--------|
| Flash (ROM) | 341.2 KB | 1.0 MB | 33.3% |
| SRAM (RAM) | 163.2 KB | 256.0 KB | 63.8% |
...
| tooth/host/libsubsys__bluetooth__host.a(att.c.obj) | 10.8 KB | 9.2 KB |
...
| ooth/host/libsubsys__bluetooth__host.a(conn.c.obj) | 8.7 KB | 6.8 KB |
